...
public interface ISpotifyApiClientService
{
     ...
     */
    <T, U> T sendRequestAndFetchResponse(ISpotifyRequest<U> request, Type typeOfReturnValue) throws IOException, InterruptedException, SpotifyResponseException;
     ...
     * @throws SpotifyResponseException when the response header has an erroneous status code
     */
    <T, U> ISpotifyAsyncResponse<T> sendRequestAndFetchResponseAsync(ISpotifyRequest<U> request, Type typeOfReturnValue) throws SpotifyResponseException;
